...
document.addEventListener("DOMContentLoaded", () => {
  function controlFromInput(fromSlider, fromInput, toInput, controlSlider) {
    ...
    fillSlider(fromInput, toInput, '#6a994e', '#6a994e', controlSlider);
    if (from > to) {
      fromSlider.value = to;
      fromInput.value = to;
    } else {
  ...
  function controlFromSlider(fromSlider, toSlider, fromInput) {
    ...
    fillSlider(fromSlider, toSlider, '#6a994e', '#6a994e', toSlider);
    if (from > to) {
      fromSlider.value = to;
      fromInput.value = to;
    } else {
...
$(document).ready(function () {
  let items = document.querySelectorAll('.menuu li');
